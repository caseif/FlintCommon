# FlintCommon [![](http://ci.caseif.net/job/FlintCommon/branch/master/badge/icon)](http://ci.caseif.net/job/FlintCommon/)
...
FlintCommon's source code and binary are provided under the MIT license.
